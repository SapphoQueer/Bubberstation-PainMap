...
GLOBAL_LIST_INIT(extra_inventory_ui_styles, list(
	'icons/hud/screen_midnight.dmi' = 'modular_zubbers/icons/hud/screen_midnight.dmi',
	'icons/hud/screen_retro.dmi' = 'modular_zubbers/icons/hud/screen_retro.dmi',
	'icons/hud/screen_plasmafire.dmi' = 'modular_zubbers/icons/hud/screen_plasmafire.dmi',
	'icons/hud/screen_slimecore.dmi' = 'modular_zubbers/icons/hud/screen_slimecore.dmi',
	'icons/hud/screen_operative.dmi' = 'modular_zubbers/icons/hud/screen_operative.dmi',
	'icons/hud/screen_clockwork.dmi' = 'modular_zubbers/icons/hud/screen_clockwork.dmi',
))
