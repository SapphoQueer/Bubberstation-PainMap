...
/datum/unit_test/underwear_items
	...
	var/list/files_by_type = list(
		briefs = 'modular_zubbers/code/modules/clothing/underwear/~generated_files/briefs.dm',
		shirt = 'modular_zubbers/code/modules/clothing/underwear/~generated_files/shirt.dm',
		socks = 'modular_zubbers/code/modules/clothing/underwear/~generated_files/socks.dm'
	)
...
/datum/unit_test/underwear_items/Run()
	...
	if(fail)
		TEST_FAIL("Underwear items generated files are out of date. Run locally by enabling unit tests, (see _compile_options.dm) and copy 'data/~generated_files' to 'modular_zubbers/code/modules/clothing/underwear/~generated_files'")
